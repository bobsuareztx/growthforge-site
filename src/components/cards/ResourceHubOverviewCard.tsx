...
type ResourceHubOverviewCardProps = {
  title: string;
  text: string;
  ctaLabel?: string;
  href?: string;
...
export default function ResourceHubOverviewCard({ title, text, ctaLabel = "Explore resource →", href = "#", meta }: ResourceHubOverviewCardProps) {
  return (
