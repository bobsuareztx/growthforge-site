...
export default function SupportContentCard({
  tag,
  title,
  text,
  ctaLabel = "Explore →",
  href = "#",
}: SupportContentCardProps) {
  return (
    <div className="rounded-[1.85rem] border border-slate-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
      ...
      <Link
        href={href}
        className="mt-6 inline-flex rounded text-sm font-semibold text-orange-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
      >
        {ctaLabel}
      </Link>
    </div>
