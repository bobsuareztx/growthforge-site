...
export async function generateMetadata({
  ...
  return {
    title: `${title} Case Study | Growthforge`,
    description: "Growthforge sample case study page.",
  };
}
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 lg:px-8 lg:py-24">
        <div className="rounded-[32px] border border-white/10 bg-white/[0.05] p-8 shadow-2xl shadow-black/20 backdrop-blur-xl lg:p-10">
          ...
          <p className="mt-6 max-w-3xl text-base leading-7 text-slate-300 sm:text-lg">
            This is a sample Growthforge case study page for the slug{" "}
            <span className="font-medium text-white">{slug}</span>.
          </p>

          <p className="mt-5 text-sm text-slate-400">
            Illustrative companies, metrics, and sample/demo structure are used
            throughout the Growthforge prototype.
          </p>
        </div>
      </section>
    </main>
